...
//     <div>
//       <h1>Welcome to your Favorites this is also a TEST for the Chat</h1>
//       <h1> Question of the Week / Find or start a book</h1>
//     </div>
...
// // if user is logged in : messages right
// // 1. prüfen ob user eingelogged ist
// // wenn ja, seine nachrichten rechts anzeigen + andere hintergrundfarbe 
// // wenn nein, alle nachrichten links anzeigen 
// // eingeloggter user hat eine id -> id von user von nachricht ist gleich zu user eingelogt id 